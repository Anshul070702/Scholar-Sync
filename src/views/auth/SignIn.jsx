  ...
  return (
    ...
    <div className="mb-10 mt-12 flex items-center justify-center">
      <div className="w-full max-w-full flex-col items-center justify-center xl:max-w-[420px] xl:pl-4">
        ...
        {/* SignIn button */}
        <div>
          <button className="linear mt-2 w-full rounded-xl bg-brand-500 py-[12px] text-base font-medium text-white transition duration-200 hover:bg-brand-600 active:bg-brand-700  dark:text-white dark:bg-brand-400 dark:hover:bg-brand-300 dark:active:bg-brand-200">
            Sign In
          </button>
        </div>
